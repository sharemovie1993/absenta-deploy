...
if [ $ERR_COUNT -eq 0 ]; then
  ...
  echo "1. Jalankan Menu 3 (Build Images) -> Untuk membuat paket aplikasi terbaru."
  echo "2. Jalankan Menu 4 (Deploy/Update) -> Untuk memasang aplikasi ke server."
  echo "3. Jalankan Menu 5 (Migration & Seed) -> Untuk menyiapkan database."
  echo "4. Cek Menu 6 (Status) -> Pastikan semua 'Running'."
else
